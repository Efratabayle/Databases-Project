...
<body>
  ...
  <div class="form-wrapper">
    <div class="form-container">
      ...
      <!-- Form submission goes to 'add_publisher.php' -->
      <form action="../add_publisher.php" method="POST">
        <input type="text" id="publisher_code" name="publisher_code" placeholder="Publisher Code" required>
        <input type="text" id="publisher_name" name="publisher_name" placeholder="Publisher Name" required>
        <input type="text" id="publisher_country" name="publisher_country" placeholder="Publisher Country" required>
